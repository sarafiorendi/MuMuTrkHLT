...
class JpsiTrkTrkTreeMaker : public edm::EDAnalyzer {

 public:
  /// default constructor
  JpsiTrkTrkTreeMaker(const edm::ParameterSet& cfg);
  /// default destructor
  virtual ~JpsiTrkTrkTreeMaker() {};
 ...
 private:
  ...
  //mumutrktrk cand hlt  
  double T_hlt_JpsiTkTkCL, T_hlt_JpsiTkTkCLTest;
  double T_hlt_JpsiTkTkPosition_x,      T_hlt_JpsiTkTkPosition_y,      T_hlt_JpsiTkTkPosition_z;
  double T_hlt_JpsiTkTkPositionError_x, T_hlt_JpsiTkTkPositionError_y, T_hlt_JpsiTkTkPositionError_z;  
  float  T_hlt_JpsiTkTkLSigma, T_hlt_JpsiTkTkCosBS;
  double T_JpsiTkTkVtx_hltReco_dx, T_JpsiTkTkVtx_hltReco_dy, T_JpsiTkTkVtx_hltReco_dz;  
  double T_TrkP_hltRecoDR, T_TrkM_hltRecoDR, T_hlt_Comb1Mass, T_hlt_Comb2Mass;
