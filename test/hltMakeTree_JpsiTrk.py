...
#                                 inFile
                            "/store/group/phys_bphys/fiorendi/720pre6/FromTemplateMenu_onMC_etaPhi117_addBMass/HLT_DisplacedPaths__phys_bphys_0.root",
                            ),
...
FILTERS  = [ "hltJpsiTkVertexFilter",
           ]

TRIGGERS = [ "HLT_DoubleMu4_JpsiTrk_Displaced_v1"
           ]
...
for i in range(len(TRIGGERS)):
  ...
  module =cms.EDAnalyzer("JpsiTrkTreeMaker",
                         ...
                         probeFilterDen      = cms.string("hltJpsiTkVertexFilter"),#not used
                         ...
                         MuMuVtxProdLabel    = cms.InputTag("hltJpsiTkVertexProducer"),
...
#                                    fileName = cms.string(outFile),
                                   fileName = cms.string("myTestTreeJpsiTrk.root"),
